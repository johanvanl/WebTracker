 ...
 * selections.
 */
public class WebsiteListActivity extends FragmentActivity implements
		WebsiteListFragment.Callbacks {
	...
	public void onItemSelected(int id) {
		if (mTwoPane) {
			...
			arguments.putInt(WebsiteDetailFragment.ARG_ITEM_ID, id);
			WebsiteDetailFragment fragment = new WebsiteDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.website_detail_container, fragment).commit();
